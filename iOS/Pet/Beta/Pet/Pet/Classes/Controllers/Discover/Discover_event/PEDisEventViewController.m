...
@interface PEDisEventViewController ()

@end

@implementation PEDisEventViewController
...
- (void)viewDidLoad
{
    ...
    titleLabel.text=NSLocalizedString(DISCOVER_EVENT, nil);
