...
@implementation PEClubDetailView
...
- (void)layoutSubviews
{
    ...
    groupIdNameLabel.frame = CGRectMake(35, 15, sizeGIN.width, sizeGIN.height);
...
//    groupIDLabel.text = @"676612962";
    ...
    siteNameLabel.frame = CGRectMake(73-sizeSNL.width, 52.5, sizeSNL.width, sizeSNL.height);
...
//    groupNewsCountLabel.text = @"125";
    ...
    groupNewsCountLabel.frame = CGRectMake(77 -sizeGNC.width,151 , sizeGNC.width, sizeGNC.height);
...
//    newsOwnerImageView.image = [UIHelper imageName:@"group_memberBg"];
...
//    newsContentLabel.text = @"雪橇犬哈市奇纯种健康...";
    ...
    [self addSubview:arrowImageView4];
...
//    groupMemberCountLabel.text = @"26";
    ...
    groupMemberCountLabel.frame = CGRectMake(77 -sizeGMC.width , 213, sizeGMC.width, sizeGMC.height);
    ...
    if (members.count >0) {
        ...
        [mOwner setImageWithURL:[NSURL URLWithString:[memberImageView1Dict objectForKey:DISCOVER_CLUBDETAIL_PETLIST_PETIAMGEURL]]
    ...
    if (members.count >1) {
        ...
        [memberImageView2 setImageWithURL:[NSURL URLWithString:[memberImageView2Dict objectForKey:DISCOVER_CLUBDETAIL_PETLIST_PETIAMGEURL]]
                         placeholderImage:[UIHelper imageName:@"group_memberBg"]];
    ...
    if (members.count >2) {
        ...
        [memberImageView3 setImageWithURL:[NSURL URLWithString:[memberImageView3Dict objectForKey:DISCOVER_CLUBDETAIL_PETLIST_PETIAMGEURL]]
                         placeholderImage:[UIHelper imageName:@"group_memberBg"]];
        ...
        if (members.count >3) {
            ...
            [memberImageView4 setImageWithURL:[NSURL URLWithString:[memberImageView4Dict objectForKey:DISCOVER_CLUBDETAIL_PETLIST_PETIAMGEURL]]
                             placeholderImage:[UIHelper imageName:@"group_memberBg"]];
    ...
    if (members.count >0) {
        ...
        memberNameLabel1.text = [memberNameLabel1Dict objectForKey:DISCOVER_CLUBDETAIL_PETLIST_PETNAME];
    ...
    if (members.count >1) {
        ...
        memberNameLabel2.text = [memberNameLabel2Dict objectForKey:DISCOVER_CLUBDETAIL_PETLIST_PETNAME];
    ...
    if (members.count >2) {
        ...
        memberNameLabel3.text = [memberNameLabel3Dict objectForKey:DISCOVER_CLUBDETAIL_PETLIST_PETNAME];
    ...
    if (members.count >3) {
        ...
        memberNameLabel4.text = [memberNameLabel4Dict objectForKey:DISCOVER_CLUBDETAIL_PETLIST_PETNAME];
    ...
    [self addSubview:arrowImageView5];
    ...
    groupIntroduceLabel.frame = CGRectMake(36, 258.5, sizeGIN.width, sizeGID.height);
...
//    groupDescriptionLabel.lineBreakMode = NSLineBreakByCharWrapping;
//    NSString *tempString = @"上海喜欢猫猫和狗狗的小伙伴我们在召唤你，快点加入我们吧，进群需要身份验证哟，你和你爱宠的真实照片!";
    ...
    //必须先初始化一个位置
    groupDescriptionLabel.frame = CGRectMake(94, 253, sizeGDL.width, 53.0f);
...
//    dateLabel.text = @"2014.6.17";
    ...
    arrowImageView8.frame = CGRectMake(296, 359, 22, 40);
