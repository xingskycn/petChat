...
#import "UIHelper.h"
@implementation PEShakeHistoryTableCell
...
- (void)layoutSubviews {
    ...
    [petNameLbl setFrame:CGRectMake(97.0f, 8.0f, sizePN.width, 14)];
    ...
    [petSignLbl setFrame:CGRectMake(97.0f, 69.5f, 160.0f, 12)];//97.0f, 69.5f, 150.0f, 12
    ...
    ownerNameLbl.textAlignment =NSTextAlignmentCenter;
