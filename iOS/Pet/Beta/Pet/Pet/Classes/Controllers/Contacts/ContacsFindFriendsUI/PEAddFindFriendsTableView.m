...
#import "PEAddFindFriendsTableView.h"
#import "UIHelper.h"
#import "PEAddFindFriendsTableCell.h"

static int pageIndex = 0;
@implementation PEAddFindFriendsTableView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString *cellID =@"PEAddFindFriendsTableCell";
    PEAddFindFriendsTableCell *cell =(PEAddFindFriendsTableCell *)[tableView dequeueReusableCellWithIdentifier:cellID];
    if (cell ==nil) {
        NSArray *array =[[NSBundle mainBundle] loadNibNamed:@"PEAddFindFriendsTableCell" owner:self options:nil];
...
//    NSDictionary *dataDict =[dataArray objectAtIndex:indexPath.row];
    ...
    cell.petSex = @"公";
    cell.contactNameLabel.text = @"anni 姐姐";
