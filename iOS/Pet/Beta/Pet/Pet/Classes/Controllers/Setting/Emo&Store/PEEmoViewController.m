...
#import "PEEmoViewController.h"

@interface PEEmoViewController ()

@end

@implementation PEEmoViewController
...
- (void)viewDidLoad
{
    ...
    titleLabel.text=NSLocalizedString(SETTING_EMO_TITLE, nil);
