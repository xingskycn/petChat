...
// RTagCloudView
#define COCOAPODS_POD_AVAILABLE_RTagCloudView
#define COCOAPODS_VERSION_MAJOR_RTagCloudView 1
#define COCOAPODS_VERSION_MINOR_RTagCloudView 0
#define COCOAPODS_VERSION_PATCH_RTagCloudView 0
