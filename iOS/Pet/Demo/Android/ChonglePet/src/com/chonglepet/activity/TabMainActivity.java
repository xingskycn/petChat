...
public class TabMainActivity extends TabActivity{ 
    ...
    public void onCreate(Bundle savedInstanceState) { 
        ...
        mTabHost.addTab(mTabHost.newTabSpec("TAG4").setIndicator("3").setContent(new Intent(this, MainActivity.class)));
        ...
        main_radio.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() { 
                    ...
                    public void onCheckedChanged(RadioGroup group, int id) { 
                    	if (id == tab_icon_fujin.getId()) {  
                    		//这里用来解决点击之后变图片
                    		tab_icon_fujin.setCompoundDrawablesWithIntrinsicBounds(0,R.drawable.button1_press,0, 0);  
                    		tab_icon_find.setCompoundDrawablesWithIntrinsicBounds(0,R.drawable.button2,0, 0);  
                    		tab_icon_chat.setCompoundDrawablesWithIntrinsicBounds(0,R.drawable.button3,0, 0);  
                    		tab_icon_contact.setCompoundDrawablesWithIntrinsicBounds(0,R.drawable.button5,0, 0);
                    		tab_icon_set.setCompoundDrawablesWithIntrinsicBounds(0,R.drawable.button3,0, 0);  
                    		tab_icon_shop.setCompoundDrawablesWithIntrinsicBounds(0,R.drawable.button5,0,0);
                            mTabHost.setCurrentTab(0);  
                        } else if (id == tab_icon_find.getId()) { 
                    		tab_icon_fujin.setCompoundDrawablesWithIntrinsicBounds(0,R.drawable.button1,0, 0);  
                    		tab_icon_find.setCompoundDrawablesWithIntrinsicBounds(0,R.drawable.button2_press,0, 0);  
                    		tab_icon_chat.setCompoundDrawablesWithIntrinsicBounds(0,R.drawable.button3,0, 0);  
                    		tab_icon_contact.setCompoundDrawablesWithIntrinsicBounds(0,R.drawable.button5,0, 0);
                    		tab_icon_set.setCompoundDrawablesWithIntrinsicBounds(0,R.drawable.button3,0, 0);  
                    		tab_icon_shop.setCompoundDrawablesWithIntrinsicBounds(0,R.drawable.button5,0,0);
                    		...
                    		tab_icon_fujin.setCompoundDrawablesWithIntrinsicBounds(0,R.drawable.button1,0, 0);  
                    		tab_icon_find.setCompoundDrawablesWithIntrinsicBounds(0,R.drawable.button2,0, 0);  
                    		tab_icon_chat.setCompoundDrawablesWithIntrinsicBounds(0,R.drawable.button3_press,0, 0);  
                    		tab_icon_contact.setCompoundDrawablesWithIntrinsicBounds(0,R.drawable.button5,0, 0);
                    		tab_icon_set.setCompoundDrawablesWithIntrinsicBounds(0,R.drawable.button3,0, 0);  
                    		tab_icon_shop.setCompoundDrawablesWithIntrinsicBounds(0,R.drawable.button5,0,0);
                    		...
                    		tab_icon_find.setCompoundDrawablesWithIntrinsicBounds(0,R.drawable.button2,0, 0);  
                    		tab_icon_chat.setCompoundDrawablesWithIntrinsicBounds(0,R.drawable.button3,0, 0);  
                    		tab_icon_contact.setCompoundDrawablesWithIntrinsicBounds(0,R.drawable.button5_press,0, 0);
                    		tab_icon_set.setCompoundDrawablesWithIntrinsicBounds(0,R.drawable.button3,0, 0);  
                    		tab_icon_shop.setCompoundDrawablesWithIntrinsicBounds(0,R.drawable.button5,0,0);  
                    		...
                    		tab_icon_chat.setCompoundDrawablesWithIntrinsicBounds(0,R.drawable.button3,0, 0);  
                    		tab_icon_contact.setCompoundDrawablesWithIntrinsicBounds(0,R.drawable.button5,0, 0);
                    		tab_icon_set.setCompoundDrawablesWithIntrinsicBounds(0,R.drawable.button3_press,0, 0);  
                    		tab_icon_shop.setCompoundDrawablesWithIntrinsicBounds(0,R.drawable.button5,0,0);
                    		//如果已经登录过了   就不用在此登录了
            				if(loginName!=null&&
            						loginPassword!=null){
                    		...
                    		tab_icon_contact.setCompoundDrawablesWithIntrinsicBounds(0,R.drawable.button5,0, 0);
                    		tab_icon_set.setCompoundDrawablesWithIntrinsicBounds(0,R.drawable.button3,0, 0);  
                    		tab_icon_shop.setCompoundDrawablesWithIntrinsicBounds(0,R.drawable.button5_press,0,0); 
