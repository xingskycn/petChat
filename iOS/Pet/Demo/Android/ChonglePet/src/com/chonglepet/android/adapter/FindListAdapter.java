...
public class FindListAdapter extends AbBaseAdapter{

	//private Context context;
	private LayoutInflater layoutInflater;
	
	public FindListAdapter(Context context,List<Map<String, String>> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null){
			hendler=new Hendler();
			convertView=layoutInflater.inflate(R.layout.find_item, null);
			
			hendler.findTextView=(TextView)convertView.findViewById(R.id.find_textview);
			hendler.findImageView=(ImageView)convertView.findViewById(R.id.find_imageview);
