...
public class PetChatGroupAdapter extends AbBaseAdapter{
	
	private Context context;

	private LayoutInflater layoutInflater;
	
	public PetChatGroupAdapter(Context context,List<Map<String, String>> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null){
			hendler=new Hendler();
			convertView=layoutInflater.inflate(R.layout.pet_chat_group_item, null);
			...
			hendler.groupSize=(TextView)convertView.findViewById(R.id.groupSize);
		...
		hendler.groupSize.setText(list.get(position).get("groupSize").toString());
