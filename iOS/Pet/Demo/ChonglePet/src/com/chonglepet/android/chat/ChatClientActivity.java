...
public class ChatClientActivity extends AbstractBaseActivity implements OnClickListener{
	...
	private LinearLayout chat_add_more;
	private Button  chat_image_button,
					chat_Camera_button,
					chat_vedio_button,
					chat_position_button,
					chat_language_button,
					chat_send_button;
	
	/////////////////////////////////////////////
	private ViewPager viewPager;
	private ArrayList<GridView> listGridviews;
	private Button chat_add_button;
	...
	protected void initHeadTitleLayout() {
		...
		head_left_button.setBackgroundResource(R.drawable.chat_button_select);
		...
		head_right_button.setBackgroundResource(R.drawable.chat_more_button_select);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		this.msgText.addTextChangedListener(myTextWatcher);
		this.msgText.setOnFocusChangeListener(new MyOnFocusChangeListener());
		...
		// 添加更多
		chat_add_button = (Button) findViewById(R.id.chat_add_button);
		chat_add_button.setOnClickListener(this);
		// 语音
		...
		chat_add_more=(LinearLayout)findViewById(R.id.chat_add_more);
...
//		final Chat newchat = cm.createChat(this.pUSERID+"@water-pc", null);
	...
	private void initBottomButton() {
		chat_image_button=(Button)findViewById(R.id.chat_image_button);
		chat_Camera_button=(Button)findViewById(R.id.chat_Camera_button);
		chat_vedio_button=(Button)findViewById(R.id.chat_vedio_button);
		chat_position_button=(Button)findViewById(R.id.chat_position_button);
		chat_language_button=(Button)findViewById(R.id.chat_language_button);
		chat_send_button=(Button)findViewById(R.id.chat_send_button);
		
		chat_image_button.setOnClickListener(this);
		chat_Camera_button.setOnClickListener(this);
		chat_vedio_button.setOnClickListener(this);
		chat_position_button.setOnClickListener(this);
		chat_language_button.setOnClickListener(this);
	...
	class MyOnFocusChangeListener implements OnFocusChangeListener{
		...
		public void onFocusChange(View v, boolean hasFocus) {
			if(hasFocus==true){
				...
				chat_add_more.setVisibility(View.GONE);
			}
		}
	}
	...
	private TextWatcher myTextWatcher=new TextWatcher() {
		...
		public void onTextChanged(CharSequence s, int start, int before, int count) {
			viewPager.setVisibility(View.GONE);
			chat_add_more.setVisibility(View.GONE);
			chat_language_button.setVisibility(View.GONE);
			chat_send_button.setVisibility(View.VISIBLE);
		}
	...
	public void onClick(View v) {
		...
		case R.id.chat_send_button:
			...
			sendMessage(msg);
			chat_language_button.setVisibility(View.VISIBLE);
			chat_send_button.setVisibility(View.GONE);
			break;
		//语言
		case R.id.chat_language_button:
			//通过Intent传递语音识别的模式，开启语音
			/* Intent intentLanguage=new Intent(RecognizerIntent.ACTION_RECOGNIZE_SPEECH);
			 //语言模式和自由模式的语音识别  
			 intentLanguage.putExtra(RecognizerIntent.EXTRA_LANGUAGE_MODEL, RecognizerIntent.LANGUAGE_MODEL_FREE_FORM);
			 //提示开启语言
			 intentLanguage.putExtra(RecognizerIntent.EXTRA_PROMPT, "开始语言");
			 //开始语言识别
			 startActivityForResult(intentLanguage, VOICE_RECOGNITION_REQUEST_CODE);*/
			break;
		// 添加
		case R.id.chat_add_button:
			chat_add_more.setVisibility(View.VISIBLE);
			viewPager.setVisibility(View.GONE);
		...
		case R.id.chat_vedio_button:
			...
			break;
		//位置
		case R.id.chat_position_button:
			break;
...
*/					 cursor.close(); 
	...
	protected void uploadImage(String iamgeUrl){
		...
		params.add(parameter);
		onRequestImageUpload(CommonConfig.IMAGE_UPLOAD, CommonConfig.imageUpload, params);
...
//		onRequestVedioUpload(CommendConfig.PET_VEDIO__UPLOAD, CommendConfig.addUploadVedioUrl, params);
	...
	public void onTaskRequestSuccess(int taskId, JSONTokener jsonTokener) {
		try {
			...
			switch (taskId) {
			case CommonConfig.IMAGE_UPLOAD:
