...
public class TabHomeActivity extends TabActivity{ 
    ...
    public void onCreate(Bundle savedInstanceState) { 
        ...
        mTabHost.addTab(mTabHost.newTabSpec("TAG1").setIndicator("0").setContent(new Intent(this, HomeActivity.class))); 
    ...
    private OnClickListener loginOnClickListener=new OnClickListener() {
		...
		public void onClick(View v) {
			...
			case R.id.formlogin_btsubmit:
				//取得填入的用户和密码
				final String USERID = TabHomeActivity.this.useridText.getText().toString();
				final String PWD = TabHomeActivity.this.pwdText.getText().toString();
	...
	private Handler handler = new Handler(){
		public void handleMessage(android.os.Message msg)
		{
			...
			else if(msg.what==2)
			{
				...
				Toast.makeText(TabHomeActivity.this, "登录失败！",Toast.LENGTH_SHORT).show();
			}
			else if(msg.what==3)
			{
				if(loginName ==null&&
...
*/
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if(1==1){
			Toast.makeText(TabHomeActivity.this, "在次点击退出程序",Toast.LENGTH_SHORT).show();
			return true;
		}
		else{
